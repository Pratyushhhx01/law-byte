...
## What it is
An AI legal assistant for Indian law. Users ask questions in plain language and get answers grounded in 40+ Indian bare acts (IPC/BNS, CrPC/BNSS, Constitution, etc.), with optional real-time web search and document drafting/review.
