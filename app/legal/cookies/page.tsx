    ...
    >
      <section>
        ...
        <p className="mt-3">
          ...
          technologies, such as local storage and pixels, which are referred
          to collectively as &ldquo;cookies&rdquo; in this Policy.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="mt-4 list-disc space-y-2 pl-6">
          ...
          <li>
            <strong className="text-white/90">Preferences:</strong>{" "}
            remembering choices such as theme, language, and layout.
          </li>
          <li>
          ...
          <li>
            <strong className="text-white/90">Marketing:</strong> only where
            you have opted in, to measure the effectiveness of campaigns.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          also stored. Disabling certain cookies may affect the
      ...
      <section>
        ...
        <p className="mt-3">
          Some cookies are set by third parties whose services we use, such
          as analytics and error monitoring providers. These third parties may
          use cookies to collect information about your online activity
